...
export class InventoryCostCenterHistoryResponse  {
    private history:  Array<InventoryCostCenterStockHistoryModel>;
    ...
    public getHistory(): Array<InventoryCostCenterStockHistoryModel> {
        return this.history;
    }

    public setHistory(history: Array<InventoryCostCenterStockHistoryModel>): void {
